<template>
    <div>
        <div style="height: 100vh; display: flex;align-items: center;justify-content: center;background-color: rgb(141, 114, 191);">
            <div style="display: flex;justify-content: center;background-color: white;padding:20px;border-radius: 10px;">
                <div style="flex:1">
                    <img style="width:600px;border-radius: 5px;" src="@/assets/demo.png">
                ...
                <div style="flex:1;margin-left: 35px;display: flex;flex-direction: column;justify-content: space-between;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <div><span style="color:#3366FF" class="pointer"></span></div>
                    </div>
                </div>
            </div>
        </div>
