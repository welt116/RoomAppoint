<template>
    <div>
        <el-container>
            <el-header style="background-color: #510f5b;">
                
                <el-menu :default-active="active" class="main-container" mode="horizontal" text-color="white"
                active-text-color=#9757b7 background-color="#510f5b"   >
                <!-- active-text-color="#28b2d4" -->
                    <el-menu-item index="">
                        <img style="height: 50px;object-fit: contain;" :src="require('@/assets/logo.jpg')">
                    </el-menu-item>

                    <el-menu-item index="/Front/Home" @click="ToPath('/Front/Home')">工大自习室预约</el-menu-item>
            ...
            <el-footer style="background-color:  #510f5b ;">
                <div style="text-align: center;color:white;font-weight: bolder;">系统归人民当家做组所有</div>
            </el-footer>
        </el-container>
